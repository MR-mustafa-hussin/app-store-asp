...
namespace app_store.Controllers
{
    public class SystemCodeDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SystemCodeId,Code,Description,OrderNo")] SystemCodeDetail systemCodeDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SystemCodeId,Code,Description,OrderNo")] SystemCodeDetail systemCodeDetail)
        {
