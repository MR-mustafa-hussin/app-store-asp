...
namespace app_store.Controllers
{
    public class SystemCodesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Description,CreatedId,CreatedOn,ModifiedById,ModifiedByOn")] SystemCode systemCode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Description,CreatedId,CreatedOn,ModifiedById,ModifiedByOn")] SystemCode systemCode)
        {
            if (id != systemCode.Id)
            {
                return NotFound();
