        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:ENG-Mustafa-Hussein@OG-CAMERA.com">info@OG-CAMERA.com</a>
                    <i class="fa fa-phone mx-2"></i>
                    <a class="navbar-sm-brand text-light text-decoration-none" href="tel:011-410-999-83">011-410-999-83</a>
                </div>
                <div>
